...
// Data icon diperbanyak dengan nama yang user-friendly untuk pencarian (Autocomplete)
const iconOptions = [
  // Spa & Relaksasi
...
export const CreateCategoryModal: React.FC<CreateCategoryModalProps> = ({
  ...
  // State untuk menyimpan aksi tombol apa yang ditekan ("save" atau "save_and_add")
  ...
  >("/master/categories", {
    ...
    onSuccess: () => {
      toast.success("Kategori berhasil ditambahkan", {
        description: "Data kategori baru telah tersimpan di sistem.",
      });

      // Cek aksi yang ditekan user
      if (submitAction === "save") {
        setIsAddCategoryOpen(false); // Tutup modal jika pilih "Simpan"
      } else {
        // Reset form ke default value jika pilih "Simpan & Buat Lagi"
        reset({
          name: "",
          description: "",
          target_audience: "Semua",
